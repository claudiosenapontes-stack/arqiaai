      ...
      <div className="relative aspect-[16/10] w-full overflow-hidden bg-neutral-100">
        ...
        <div className="absolute inset-0">
          <div className="flex h-full items-center">
            <div className="w-full h-full bg-[linear-gradient(to_top,rgba(0,0,0,0.68),rgba(0,0,0,0.30)_42%,rgba(0,0,0,0.10)_72%,rgba(0,0,0,0)_100%)] px-6 py-10 md:px-10 md:py-14">
