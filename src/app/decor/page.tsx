    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="mx-auto max-w-5xl px-6 py-24">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-4 font-serif text-5xl tracking-tight">Decor</h1>
          <p className="mt-4 text-neutral-600">Curated objects for refined spaces. We’ll launch this collection next.</p>
